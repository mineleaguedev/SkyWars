...
public class PlayerTrackerCompass {
    ...
    public void useItem(Player player) {
        ...
        List<Player> players = new ArrayList<>(SkyWars.getGameManager().getPlayers());
        ...
        if(targetPlayer != null) {
            ...
            BukkitTask task = new BukkitRunnable() {
                ...
                public void run() {
                    ...
                    else if(!SkyWars.getGameManager().getPlayers().contains(playersTargets.get(player))) {
